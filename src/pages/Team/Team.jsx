...
export const Team = () => {
  ...
  return (
    ...
    >
      ...
      <div className="lg:px-24 lg:pt-20 lg:pb-28 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 ">
        <div className="w-[250px] flex flex-col shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] pb-10 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg">
        <div className="w-full h-52">
          ...
          <h5 className="text-xl text-center font-bold mt-8">
            Dr. Adewale Johnson
          </h5>
          <p className="text-center text-secondary">Managing Dir. / CEO</p>
        ...
        <div className="w-[250px] flex flex-col shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] pb-10 transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg">
          <div className="w-full h-52">
            <img
              src="https://images.pexels.com/photos/7841444/pexels-photo-7841444.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="" className="w-full h-full"
            />
          </div>
          <h5 className="text-xl text-center font-bold mt-8">
