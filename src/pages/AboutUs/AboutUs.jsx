...
export const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:px-24 lg:py-20 items-center">
        ...
        <div className="w-[50%] gap-6 bg-primary text-white flex flex-col justify-center items-center h-80">
          <h3 className="text-center lg:text-3xl font-bold">OUR VISION</h3>
          <p className="text-center px-20 text-xl">
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:px-24 lg:pb-20 items-center">
        <div className="w-[50%] gap-6 bg-secondary text-white flex flex-col justify-center items-center h-80">
          <h3 className="text-center lg:text-3xl font-bold">OUR MISSION</h3>
          <p className="text-center px-20 text-xl">
      ...
      <div className="flex flex-col gap-10 lg:px-24 lg:pb-20 items-center justify-center">
        <h3 className="text-center lg:text-3xl font-bold text-[#1a2423]">
          OUR VALUES
        </h3>
        ...
        <div className="group flex flex-col gap-2 w-[270px] py-16 border items-center hover:bg-primary hover:text-white transition duration-500 rounded-lg">
          <PiHandshakeDuotone size={80} className="text-[#6cbe00] group-hover:text-white" />
          <p className="text-xl font-bold">Precision & Trust</p>
        </div>
          <div className="group flex flex-col gap-2 w-[270px] py-16 border items-center hover:bg-primary hover:text-white transition duration-500 rounded-lg">
            <FaRegThumbsUp size={80} className="text-[#6cbe00] group-hover:text-white" />
            <p className="text-xl font-bold">Quality</p>
          </div>
          <div className="group flex flex-col gap-2 w-[270px] py-16 border items-center hover:bg-primary hover:text-white transition duration-500 rounded-lg">
            <IoRocketOutline size={80} className="text-[#6cbe00] group-hover:text-white" />
            <p className="text-xl font-bold">Innovation</p>
          </div>
          <div className="group flex flex-col gap-2 w-[270px] py-16 border items-center hover:bg-primary hover:text-white transition duration-500 rounded-lg">
            <GrUserWorker size={80} className="text-[#6cbe00] group-hover:text-white" />
