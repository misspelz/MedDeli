...
export const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div className="lg:px-24 lg:py-20">
        <h2 className="text-4xl font-bold ">Our Pathology Departments</h2>

        <div className="grid grod-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10  lg:pb-20 items-center mt-10">
          <div className=" gap-6 bg-primary text-white flex flex-col justify-center items-center h-40">
            <h3 className="text-center lg:text-xl font-bold">SEROLOGY</h3>
          </div>
          <div className=" gap-6 bg-primary text-white flex flex-col justify-center items-center h-40">
            <h3 className="text-center lg:text-xl font-bold">HEAMATOLOGY</h3>
          </div>
          <div className=" gap-6 bg-primary text-white flex flex-col justify-center items-center h-40">
          ...
          <div className=" gap-6 bg-primary text-white flex flex-col justify-center items-center h-40">
            <h3 className="text-center lg:text-xl font-bold">IMMUNOLOGY</h3>
          </div>
          <div className=" gap-6 bg-primary text-white flex flex-col justify-center items-center h-40">
            <h3 className="text-center lg:text-xl font-bold px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-10  lg:pb-20 items-center justify-between">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-[50%] gap-6 bg-secondary text-white flex flex-col justify-center items-start px-10 py-20">
        ...
        <div className="flex flex-col lg:flex-row lg:pb-5 items-center">
          <div
            className="w-[50%]"
            style={{
